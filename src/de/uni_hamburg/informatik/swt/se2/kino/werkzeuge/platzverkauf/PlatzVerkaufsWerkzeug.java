...
public class PlatzVerkaufsWerkzeug
{
    ...
    private void verkaufePlaetze(Vorstellung vorstellung)
    {
        ...
        _bezahlWerkzeug = new BezahlWerkzeug(vorstellung.getPreisFuerPlaetze(plaetze));
        //http://alvinalexander.com/java/jdialog-close-closing-event
        if(_bezahlWerkzeug.getVerkauf())
        {
